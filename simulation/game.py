...
def loads_roads(game):
    ...
    add_road(11, (1056, 1487), (1056, 920), 27, [], [])
    add_road(12, (1005, 1487), (1005, 920), 26, [], [])
    add_road(13, (950, 1487), (950, 920), 25, [], [])
    add_road(14, (1110, 1487), (1110, 920), 28, [], [])  # bus line
    add_road(15, (688, 100), (688, 540), 35, [43], [])
    add_road(16, (740, 100), (740, 850), 34, [44,46], [])
    add_road(17, (792, 100), (792, 8563), 33, [48,47], [])
    ...
    add_road(40, (675, 853) ,(1090, 906), None ,[42], [])
    add_road(41,(675, 800), (1090 , 856), None, [],[])
    add_road(42,  (1090,906), (3040,906), None,[],[])
...
def load_spawnpoints(game):
    ...
    for type, road_idx in spawnpoints:
        if   type in ['man', 'bike']: speed = 15
        elif type in ['car', 'boat']: speed = 65
