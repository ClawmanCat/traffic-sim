...
def loads_roads(game):
    ...
    add_road(13, (950, 1485), (950, 540), 25, [54], [
        (Box((938, 1237), (965, 1265)), VC),
        (Box((938, 1421), (965, 1448)), VW)
    ])
    ...
    add_road(56, (3364, 554), (3115, 554), None, [57, 65], [])
    ...
    add_road(69, (2060, 537), (1056, 537), None, [70], [])
    add_road(70, (1056, 537), (1056, 100), None, [], [])
    add_road(71, (2060, 588), (720, 588), None, [], [])
    add_road(72, (720, 588), (688, 540), None, [43], [])
    add_road(73, (2060, 648), (720, 648), None, [74], [])
    add_road(74, (720, 648), (688, 591), None, [51], [])
