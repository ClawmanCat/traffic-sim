...
class Layout:
    ...
    def load_intersection_layout(game):
        ...
        add_light(2, [25, 30, 31, 35], (500, 620), 4)
        ...
        add_light(37, [38], (2650, 1179), 11, sync = False)
        add_light(38, [37], (2650, 251), 11, sync = False)
    ...
    def loads_roads(game):
        ...
        add_road(11, (1056, 1487), (1056, 906), 27, [52], [
            (Box((1043, 1260), (1073, 1290)), VW),
            (Box((1043, 1451), (1073, 1481)), VC)
        ])
        add_road(12, (1005, 1487), (1005, 856), 26, [53], [
            (Box((991, 1260), (1021, 1290)), VW),
            (Box((991, 1451), (1021, 1481)), VC)
        ])
        add_road(13, (950, 1485), (950, 540), 25, [54], [
            (Box((940, 1260), (970, 1290)), VW),
            (Box((936, 1451), (966, 1481)), VC)
        ])
        ...
        add_road(22, (1268, 435), (1268, 720), 14, [77], [
            (Box((1255, 450), (1285, 480)), VW)
        ])
        add_road(23, (1211, 435), (1211, 720), 14, [86], [
            (Box((1200, 450), (1230, 480)), VW)
        ])
        add_road(24, (1150, 328), (950, 328), 16, [102], [
            (Box((1110, 316), (1140, 346)), VW)
        ])
        add_road(25, (1150, 380), (950, 380), 16, [103], [
            (Box((1110, 368), (1140, 398)), VW)
        ])
        add_road(26, (478, 461), (478, 620), 5, [96], [
            (Box((460, 464), (490, 494)), VW)
        ])
        add_road(27, (531, 461), (531,  620), 5, [97], [
            (Box((517, 464), (547, 494)), VW)
        ])
        add_road(28, (590, 1062), (840, 1062), 10, [89], [
            (Box((595, 1050), (625, 1080)), VW)
        ])
        add_road(29, (590, 1115), (840, 1115), 10, [90], [
            (Box((595, 1100), (625, 1130)), VW)
        ])
        ...
        add_road(77, (1268, 720), (1268, 985), 12, [], [
            (Box((1255, 755), (1285, 785)), VW)
        ])
        ...
        add_road(84, (1268, 985), (1268, 840), 15, [85], [
            (Box((1255, 950), (1285, 980)), VW)
        ])
        add_road(85, (1268, 840), (1268, 461), 13, [], [
            (Box((1255, 750), (1285, 780)), VW)
        ])
        add_road(86, (1211, 720), (1211, 985), 12, [], [
            (Box((1200, 755), (1230, 785)), VW)
        ])
        add_road(87, (1211, 985), (1211, 800), 15, [88], [
            (Box((1200, 950), (1230, 980)), VW)
        ])
        add_road(88, (1211, 800), (1211, 461), 13, [], [
            (Box((1200, 750), (1230, 780)), VW)
        ])
        add_road(89, (840, 1062), (1135, 1062), 7, [], [
            (Box((870, 1050), (900, 1080)), VW)
        ])
        add_road(90, (840, 1115), (1134, 1115), 7, [], [
            (Box((870, 1100), (900, 1130)), VW)
        ])
        add_road(91, (1140, 1062), (1000, 1062), 9, [94], [
            (Box((1110, 1050), (1140, 1080)), VW)
        ])
        add_road(92, (1140, 1115), (1000, 1115), 9, [95], [
            (Box((1110, 1100), (1140, 1130)), VW)
        ])
        add_road(94, (1000, 1062), (610, 1062), 6, [], [
            (Box((810, 1050), (840, 1080)), VW)
        ])
        add_road(95, (1000, 1115), (610, 1115), 6, [], [
            (Box((810, 1100), (840, 1130)), VW)
        ])
        add_road(96, (478, 620), (478, 985), 3, [], [
            (Box((460, 660), (490, 690)), VW)
        ])
        add_road(97, (531, 620), (531, 985), 3, [], [
            (Box((517, 660), (547, 690)), VW)
        ])
        add_road(98, (478, 985), (478, 700), 4, [100], [
            (Box((460, 950), (490, 980)), VW)
        ])
        add_road(99, (531, 985), (531, 700), 4, [101], [
            (Box((517, 950), (547, 980)), VW)
        ])
        add_road(100, (478, 700), (478, 461), 2, [], [
            (Box((460, 645), (490, 675)), VW)
        ])
        add_road(101, (531, 700), (531, 461), 2, [], [
            (Box((517, 645), (547, 675)), VW)
        ])
        add_road(102, (950, 328), (610, 328), 18, [], [
            (Box((850, 316), (880, 346)), VW)
        ])
        add_road(103, (950, 380), (610, 380), 18, [], [
            (Box((850, 368), (880, 398)), VW)
        ])
        add_road(104, (595, 328), (820, 328), 19, [106], [
            (Box((600, 316), (630, 346)), VW)
        ])
        add_road(105, (595, 380), (820, 380), 19, [107], [
            (Box((600, 368), (630, 398)), VW)
        ])
        add_road(106, (820, 328), (1134, 328), 17, [], [
            (Box((910, 316), (940, 346)), VW)
        ])
        add_road(107, (820, 380), (1134, 380), 17, [], [
            (Box((910, 368), (940, 398)), VW)
        ])
